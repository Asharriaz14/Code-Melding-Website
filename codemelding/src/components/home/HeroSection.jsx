      ...
      <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto gap-8 lg:grid-cols-12 lg:py-16 relative">
        ...
        <div className="mr-auto place-self-center lg:col-span-7 px-4 md:px-8">
          ...
          <p className="max-w-2xl mb-6 font-medium text-Content sm:mb-8 text-lg">
            Empowering Startups with Expert Mobile App <br className="hidden md:block" />
        ...
        <div className="lg:mt-0 lg:col-span-5 lg:flex lg:justify-end">
          <div className="relative w-full max-w-lg">
            <motion.div className="relative box " initial={{ opacity: 0, scale: 0.5 }}
      ...
      transition={{
        ...
        ease: [0, 0.71, 0.2, 1.01]
              ...
              <img 
                ...
                alt="Hero"
              />
              <img className="absolute bottom-0 left-0 w-1/3 h-auto rounded-lg" src={Mobile1} alt="Mobile1" />
              <img className="absolute bottom-0 right-0 w-1/2 h-auto rounded-lg md:-right-12" src={Mobile2} alt="Mobile2" />
            </motion.div>
          </div>
        </div>
