...
const ArrowButton = ({ onClick, direction }) => (
  <button
    className={`absolute -bottom-12 right-5 ${
      direction === "right" ? "" : "mx-10"
    } items-end text-Content p-2 rounded-full focus:outline-none`}
    onClick={onClick}
  >
...
const testimonials = [
  {
    ...
    name: "John Doe",
    content:
      "are great with time management and produce high-quality work. Because of how satisfied we’ve been with their work on this project.",
    place: "New York, USA",
