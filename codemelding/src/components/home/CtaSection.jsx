...
function Cta() {
    ...
    <div className="my-16">
      ...
      >
        <div className="flex flex-col justify-center px-4 lg:px-12 py-4 w-full lg:w-1/2">
          <p className="text-2xl lg:text-4xl  mb-4 text-white font-semibold">What We Can Do</p>
          <p className="text-sm md:text-lg mb-8 md:mb-4 text-white">Excepteur sint occaecat cupidatat non proident</p>
  ...
  />
        ...
        <div className="w-full lg:w-1/2 relative flex items-end ">
          <img
            src={HaroonImage}
            alt="Haroon"
